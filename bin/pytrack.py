...
if dynap_ma_run:
    def dynap_ma(track_version   = default_track_version,
        ...
        args = [track_version, 'dynap_ma',
            ...
            str(nr_turns),
            str(y0),
            str(e_init), str(e_delta),
            str(nr_steps_back), str(rescale), str(nr_iterations),
            str(s_min), str(s_max),
            str(nr_threads)]
...
if dynap_pxa_run:
    def dynap_pxa(track_version   = default_track_version,
                  ...
                  y0              = dynap_pxa_y0,
                  e_init          = dynap_pxa_e_init,
                  e_delta         = dynap_pxa_e_delta,
...
if dynap_pya_run:
    def dynap_pya(track_version   = default_track_version,
                  ...
                  y0              = dynap_pya_y0,
                  e_init          = dynap_pya_e_init,
                  e_delta         = dynap_pya_e_delta,
